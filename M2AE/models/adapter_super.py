...
class AdapterSuper(nn.Module):
    def __init__(self,
        ...
        if self.super_reductuion_dim > 0:
           # self.attn1 = Attention(self.embed_dims, num_heads=num_heads, qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop, proj_drop=proj_drop)
...
class AdapterSuper_fn(nn.Module):
    def __init__(self,
                 embed_dims,
                 reduction_dims,
                 num_heads, qkv_bias, 
        ...
        super(AdapterSuper_fn, self).__init__()
