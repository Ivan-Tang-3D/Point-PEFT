...
class Block(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        #self.cache_gate = torch.nn.Parameter(torch.zeros(num_tokens, dim))
        #self.cache_gate = torch.nn.Parameter(torch.zeros(1))
    ...
    #     return x
    def forward(self, x, mask=None, center1=None, center2=None, neighborhood=None, idx=None, center_idx=None, num_group=None, group_size=None, cp_feat=None, cp_conv=None, if_maxmean=None, pro_cof=None, center_cof=None,ad_cof=None, attn1=None, norm3=None,
    layer_id=None):
        ...
        #cache_gate = self.cache_gate.repeat(center2.shape[0], 1, 1)
        # cp
        if cp_feat != None:
        ...
        #x_neighborhoods = torch.cat((prompt.repeat(1,center2.shape[1],1,1).reshape(B*center2.shape[1], self.num_tokens, -1), x_neighborhoods), 1)
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, x, pos,mask=None, center=None, center2=None, neighborhood=None, idx=None, center_idx=None, num_group=None, group_size=None, cp_feat=None, if_maxmean=None, pro_cof=None, center_cof=None, ad_cof=None):
        for layer_id, block in enumerate(self.blocks):
            x = block(x + pos,mask, center,center2, neighborhood, idx, center_idx, num_group, group_size, cp_feat=cp_feat, if_maxmean=if_maxmean, pro_cof=pro_cof, center_cof=center_cof,ad_cof=ad_cof,  attn1=self.attn1, norm3=self.norm3, layer_id=layer_id)
        return x
